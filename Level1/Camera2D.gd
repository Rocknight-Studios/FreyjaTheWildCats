...
export var start_scroll_position_y = 0.0 # To be able to jump to some place in the scroll.
export var stop_and_clamp_position_y = -34020.0 # Where to stop and clamp the level movement.
export var scroll_speed = 200.0 # How quickly to move the background.
...
func scroll_the_camera(speed):
	...
	ui_z_index.position = Vector2(0.0, -speed)
